...
import { createInvoice, ValidationState } from '@/app/lib/actions'
import { useActionState } from 'react'
import Link from 'next/link'
import { CheckIcon, ClockIcon, CurrencyDollarIcon, UserCircleIcon } from '@heroicons/react/24/outline'
import { Button } from '@/app/ui/primitives/button'
import { ErrorMessage } from '@/app/ui/primitives/error-message'

export default function Form({ customers }: { customers: CustomerField[] }) {
  const initialState: ValidationState = { message: null, errors: {} }
  const [validationState, formAction] = useActionState(createInvoice, initialState)
